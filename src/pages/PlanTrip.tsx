          ...
          {step === 7 && (
            <div className="py-6">
              {generating ? (
                ...
                <AIItineraryResult data={itineraryData} weatherData={weatherData} nearbyPlaces={nearbyPlaces} upcomingEvents={upcomingEvents} destinationPhotos={destinationPhotos} tripStartDate={dateRange.from} />
              ) : error ? (
